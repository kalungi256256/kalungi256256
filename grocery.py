# Enhancement: Added a customer loyalty discount system that gives 5% off orders over $20
...
def main():
    ...
    try:
        # Read the products inventory from products.csv
        products_dict = read_dictionary("products.csv", 0)
        
        # Initialize receipt variables
        store_name = "Fresh Valley Market"
        total_items = 0
        subtotal = 0.0
        sales_tax_rate = 0.06
        ordered_items = []
